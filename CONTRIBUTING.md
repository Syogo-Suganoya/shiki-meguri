...
ブラウザで <http://localhost:8080/> を開くと、機能と使い方をまとめたトップページが出ます。
「アプリを開く」からアプリ（<http://localhost:8080/console.html>）へ入ります。
...
<http://localhost:8080/console.html?dev=1> を開くと、最下部にだけ帯が出ます。
